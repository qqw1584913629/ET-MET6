...
namespace ET
{
    public static class GameObjectPoolHelper
    {
        ...
        public static void InitPool( string poolName, int size, PoolInflationType type = PoolInflationType.DOUBLE)
        {
            ...
            else
            {
                try
                {
                    ...
                    GameObject pb = GetGameObjectByYooAssets(poolName);
                    if (pb == null)
                    {
        ...
        //     return pb;
        // }
        public static GameObject GetGameObjectByYooAssets( string poolName)
        {
            GameObject pb = null;

            ResourcePackage resourcePackage = YooAssets.GetPackage("Bundles");
            
            pb = resourcePackage.LoadAssetSync<GameObject>(poolName).AssetObject as GameObject;
