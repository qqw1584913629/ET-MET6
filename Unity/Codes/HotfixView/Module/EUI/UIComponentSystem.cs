    ...
    public static class UIComponentSystem
    {
        ...
        public static void UnLoadWindow(this UIComponent self,WindowID id,bool isDispose = true)
        {
            ...
            if(baseWindow.IsPreLoad)
            {
                ...
                Game.Scene.GetComponent<ResourcesComponentYooAsset>()?.UnloadAssetOperationHandle(baseWindow.UIPrefabGameObject.name);
        ...
        private static void LoadBaseWindows(this UIComponent self,  UIBaseWindow baseWindow)
        {
            ...
            GameObject go                      = ResourcesComponentYooAsset.Instance.LoadAsset<GameObject>( value ) ;
        ...
        private static async ETTask LoadBaseWindowsAsync(this UIComponent self,  UIBaseWindow baseWindow)
        {
            ...
            GameObject go                      = await ResourcesComponentYooAsset.Instance.LoadAssetAsync<GameObject>(value) as GameObject;
